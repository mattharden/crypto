...
var kexAlgoMap = map[string]kexAlgorithm{
	...
	kexAlgoDH14SHA256:       &dhGroupKexAlgo{group: &dhGroup14, hash: crypto.SHA256},
	kexAlgoDH16SHA512:       &dhGroupKexAlgo{group: &dhGroup16, hash: crypto.SHA512},
	kexAlgoDH18SHA512:       &dhGroupKexAlgo{group: &dhGroup18, hash: crypto.SHA512},
...
var (
	...
	// and diffie-hellman-group14-SHA256 in draft-ietf-curdle-ssh-modp-dh-sha2-00.
	dhGroup14 = dhGroup{
		g: two,
	...
	// It's used in diffie-hellman-group16-sha512 in draft-ietf-curdle-ssh-modp-dh-sha2-00.
	dhGroup16 = dhGroup{
		g: two,
	...
	// It's used in diffie-hellman-group18-sha512 in draft-ietf-curdle-ssh-modp-dh-sha2-00
	dhGroup18 = dhGroup{
		g: two,
